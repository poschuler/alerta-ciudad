...
function success(position) {
  ...
  s.attr("class","success");
	...
	<?php if(!isset($_GET['latitude'])): ?>
		window.location.href="index_other.php?latitude="+position.coords.latitude+"&longitude="+position.coords.longitude;
    <?php endif; ?>
...
function alerta(tipo,latitud,longitud)
{
	...
	alert("Alerta Reportada con éxito");
}
